...
type
  ...
  TposInformation = class
    ...
    public
      ...
      procedure insertSales(productIDSales,productNameSales,productQuantitySales,productPriceSales,productAmountSales,DateofPruchase,discount:String);
  end;
...
begin
  try
     ...
     '(productID,productName,qty,price,amount,dateofPurchase,discount) '+
     'values (:productID,:productName,:qty,:price,:amount,:dateofPurchase,:discount)';
