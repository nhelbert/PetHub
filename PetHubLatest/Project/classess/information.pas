  ...
  try
     ...
     while not Form1.loginquery.EOF do begin
       ...
       Form10.secQ2.Items.Add(Form1.loginquery.Fields[9].AsAnsiString);
        ...
        Form10.lblq1.Caption   := Form1.loginquery.Fields[7].AsAnsiString;
       Form10.lblq2.Caption   := Form1.loginquery.Fields[8].AsAnsiString;
       Form10.lblq3.Caption   := Form1.loginquery.Fields[9].AsAnsiString;
